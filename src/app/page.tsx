      ...
      <section className="py-16 md:py-24 bg-primary/10">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 font-headline">
            De Nuestra Comunidad Apícola Querida
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row gap-8 items-center">
          <div className="w-full md:w-1/2">
            <h2 className="text-3xl font-bold font-headline mb-4">
              Sabiduría Apícola Impulsada por IA <Sparkles className="inline-block text-accent h-8 w-8" />
            </h2>
            <p className="text-muted-foreground text-lg mb-6">
              Obtén consejos útiles al instante generados por nuestro asistente de IA. Ya seas un apicultor novato o experimentado, siempre hay algo nuevo por aprender.
            </p>
            <BeekeepingTip section="Página Principal" topic="Apicultura General" />
          </div>
          <div className="w-full md:w-1/2">
            <Image
              src="https://i.ibb.co/8nD43pKZ/20240119-113828.jpg"
              alt="Gráfico estilizado de una abeja y un microchip"
              width={600}
              height={400}
              className="rounded-lg shadow-lg"
              data-ai-hint="abeja microchip"
            />
          </div>
        </div>
      </section>
